...
VK_QUEUE_FAMILY_EXTERNAL = 4294967295
VK_QUEUE_FAMILY_FOREIGN_EXT = 4294967295
...
VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV = 0.5
...
class VkImageLayout(IntEnum):
    ...
    VK_IMAGE_LAYOUT_SHADING_RATE_OPTIMAL_NV = 1000226003
...
class VkDescriptorType(IntEnum):
    ...
    VK_DESCRIPTOR_TYPE_MUTABLE_VALVE = 1000494000
...
class VkPipelineBindPoint(IntEnum):
    ...
    VK_PIPELINE_BIND_POINT_RAY_TRACING_NV = 1000347000
...
class VkIndexType(IntEnum):
    ...
    VK_INDEX_TYPE_NONE_NV = 1000150000

class VkFilter(IntEnum):
    VK_FILTER_NEAREST = 0
    VK_FILTER_LINEAR = 1
    VK_FILTER_CUBIC_IMG = 1000170000
...
class VkStructureType(IntEnum):
    ...
    VK_STRUCTURE_TYPE_ATTACHMENT_SAMPLE_COUNT_INFO_NV = 1000136008
    ...
    VK_STRUCTURE_TYPE_CALIBRATED_TIMESTAMP_INFO_EXT = 1000543000
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COMPUTE_SHADER_DERIVATIVES_FEATURES_NV = 1000511000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_FEATURES_NV = 1000202000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MESH_SHADER_PROPERTIES_NV = 1000202001
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_SHADER_BARYCENTRIC_FEATURES_NV = 1000322000
    ...
    VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_EXT = 1000486000
    VK_STRUCTURE_TYPE_SURFACE_PRESENT_SCALING_CAPABILITIES_EXT = 1000486001
    VK_STRUCTURE_TYPE_SURFACE_PRESENT_MODE_COMPATIBILITY_EXT = 1000486002
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_SWAPCHAIN_MAINTENANCE_1_FEATURES_EXT = 1000487000
    VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_FENCE_INFO_EXT = 1000487001
    VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODES_CREATE_INFO_EXT = 1000487002
    VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_MODE_INFO_EXT = 1000487003
    VK_STRUCTURE_TYPE_SWAPCHAIN_PRESENT_SCALING_CREATE_INFO_EXT = 1000487004
    VK_STRUCTURE_TYPE_RELEASE_SWAPCHAIN_IMAGES_INFO_EXT = 1000487005
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_FEATURES_EXT = 1000612000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_ROBUSTNESS_2_PROPERTIES_EXT = 1000612001
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RASTERIZATION_ORDER_ATTACHMENT_ACCESS_FEATURES_ARM = 1000463000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_RGBA10X6_FORMATS_FEATURES_EXT = 1000344000
    VK_STRUCTURE_TYPE_DIRECTFB_SURFACE_CREATE_INFO_EXT = 1000346000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MUTABLE_DESCRIPTOR_TYPE_FEATURES_VALVE = 1000494000
    VK_STRUCTURE_TYPE_MUTABLE_DESCRIPTOR_TYPE_CREATE_INFO_VALVE = 1000494002
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_VERTEX_INPUT_DYNAMIC_STATE_FEATURES_EXT = 1000352000
    VK_STRUCTURE_TYPE_VERTEX_INPUT_BINDING_DESCRIPTION_2_EXT = 1000482001
    VK_STRUCTURE_TYPE_VERTEX_INPUT_ATTRIBUTE_DESCRIPTION_2_EXT = 1000482002
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_PRESENT_MODE_FIFO_LATEST_READY_FEATURES_EXT = 1000621000
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_DEPTH_CLAMP_ZERO_ONE_FEATURES_EXT = 1000604000
    ...
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_FEATURES_QCOM = 1000619000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_FRAGMENT_DENSITY_MAP_OFFSET_PROPERTIES_QCOM = 1000619001
    VK_STRUCTURE_TYPE_SUBPASS_FRAGMENT_DENSITY_MAP_OFFSET_END_INFO_QCOM = 1000619002
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_FEATURES_NV = 1000426000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_COPY_MEMORY_INDIRECT_PROPERTIES_NV = 1000549001
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_FEATURES_NV = 1000550000
    VK_STRUCTURE_TYPE_PHYSICAL_DEVICE_MEMORY_DECOMPRESSION_PROPERTIES_NV = 1000550001
    ...
    VK_STRUCTURE_TYPE_RENDERING_END_INFO_EXT = 1000630003
...
class VkSubpassContents(IntEnum):
    ...
    VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_EXT = 1000562000
...
class VkBufferUsageFlagBits2(IntEnum):
...
class VkPipelineCreateFlagBits2(IntEnum):
    ...
    VK_PIPELINE_CREATE_2_RAY_TRACING_SKIP_BUILT_IN_PRIMITIVES_BIT_KHR = 4096
...
class VkSemaphoreCreateFlagBits(IntEnum):
    pass
...
class VkMemoryMapFlagBits(IntEnum):
...
class VkPresentModeKHR(IntEnum):
    ...
    VK_PRESENT_MODE_FIFO_LATEST_READY_EXT = 1000621000
...
class VkDisplaySurfaceStereoTypeNV(IntEnum):
...
class VkSwapchainImageUsageFlagBitsANDROID(IntEnum):
    VK_SWAPCHAIN_IMAGE_USAGE_SHARED_BIT_ANDROID = 1

class VkTimeDomainKHR(IntEnum):
...
class VkDebugReportObjectTypeEXT(IntEnum):
    ...
    VK_DEBUG_REPORT_OBJECT_TYPE_DESCRIPTOR_UPDATE_TEMPLATE_KHR_EXT = 1000011000
...
class VkClusterAccelerationStructureIndexFormatFlagBitsNV(IntEnum):
...
class VkClusterAccelerationStructureTypeNV(IntEnum):
...
class VkClusterAccelerationStructureOpTypeNV(IntEnum):
...
class VkClusterAccelerationStructureOpModeNV(IntEnum):
...
class VkClusterAccelerationStructureClusterFlagBitsNV(IntEnum):
    VK_CLUSTER_ACCELERATION_STRUCTURE_CLUSTER_ALLOW_DISABLE_OPACITY_MICROMAPS_NV = 1

class VkClusterAccelerationStructureGeometryFlagBitsNV(IntEnum):
...
class VkClusterAccelerationStructureAddressResolutionFlagBitsNV(IntEnum):
...
class VkLayerSettingTypeEXT(IntEnum):
...
class VkPrivateDataSlotCreateFlagBits(IntEnum):
    pass
...
class VkQueueGlobalPriority(IntEnum):
...
class VkQueryPoolCreateFlagBits(IntEnum):
...
class VkMemoryDecompressionMethodFlagBitsEXT(IntEnum):
...
class VkRefreshObjectFlagBitsKHR(IntEnum):
    pass
...
class VkLineRasterizationMode(IntEnum):
...
class VkShaderModuleCreateFlagBits(IntEnum):
    pass
...
class VkFaultQueryBehavior(IntEnum):
...
class VkPipelineMatchControl(IntEnum):
...
class VkAccessFlagBits2(IntEnum):
    VK_ACCESS_2_NONE = 0
...
class VkPipelineStageFlagBits2(IntEnum):
...
class VkSciSyncPrimitiveTypeNV(IntEnum):
...
class VkPipelineCacheValidationVersion(IntEnum):
...
class VkRenderingAttachmentFlagBitsKHR(IntEnum):
...
class VkResolveImageFlagBitsKHR(IntEnum):
...
class VkFrameBoundaryFlagBitsEXT(IntEnum):
    VK_FRAME_BOUNDARY_FRAME_END_BIT_EXT = 1

class VkPresentScalingFlagBitsKHR(IntEnum):
...
class VkPresentGravityFlagBitsKHR(IntEnum):
...
class VkPhysicalDeviceSchedulingControlsFlagBitsARM(IntEnum):
...
class VkPresentStageFlagBitsEXT(IntEnum):
...
class VkPastPresentationTimingFlagBitsEXT(IntEnum):
...
class VkPresentTimingInfoFlagBitsEXT(IntEnum):
...
class VkVideoSessionParametersCreateFlagBitsKHR(IntEnum):
...
class VkVideoEncodeFlagBitsKHR(IntEnum):
...
class VkVideoEncodeUsageFlagBitsKHR(IntEnum):
...
class VkVideoEncodeContentFlagBitsKHR(IntEnum):
...
class VkVideoEncodeTuningModeKHR(IntEnum):
...
class VkVideoEncodeCapabilityFlagBitsKHR(IntEnum):
...
class VkVideoEncodeFeedbackFlagBitsKHR(IntEnum):
...
class VkVideoEncodeRateControlModeFlagBitsKHR(IntEnum):
...
class VkVideoEncodeIntraRefreshModeFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH264CapabilityFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH264StdFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH264RateControlFlagBitsKHR(IntEnum):
...
class VkHostImageCopyFlagBits(IntEnum):
...
class VkPartitionedAccelerationStructureOpTypeNV(IntEnum):
...
class VkPartitionedAccelerationStructureInstanceFlagBitsNV(IntEnum):
...
class VkImageFormatConstraintsFlagBitsFUCHSIA(IntEnum):
    pass

class VkImageConstraintsInfoFlagBitsFUCHSIA(IntEnum):
...
class VkFormatFeatureFlagBits2(IntEnum):
...
class VkVideoEncodeH265CapabilityFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH265StdFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH265RateControlFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH265CtbSizeFlagBitsKHR(IntEnum):
...
class VkVideoEncodeH265TransformBlockSizeFlagBitsKHR(IntEnum):
...
class VkVideoEncodeAV1CapabilityFlagBitsKHR(IntEnum):
...
class VkVideoEncodeAV1StdFlagBitsKHR(IntEnum):
...
class VkVideoEncodeAV1RateControlFlagBitsKHR(IntEnum):
...
class VkVideoEncodeAV1SuperblockSizeFlagBitsKHR(IntEnum):
    VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_64_BIT_KHR = 1
    VK_VIDEO_ENCODE_AV1_SUPERBLOCK_SIZE_128_BIT_KHR = 2

class VkVideoEncodeAV1PredictionModeKHR(IntEnum):
...
class VkVideoEncodeAV1RateControlGroupKHR(IntEnum):
...
class VkExportMetalObjectTypeFlagBitsEXT(IntEnum):
...
class VkPipelineRobustnessBufferBehavior(IntEnum):
...
class VkPipelineRobustnessImageBehavior(IntEnum):
...
class VkDeviceFaultFlagBitsKHR(IntEnum):
...
class VkDeviceFaultAddressTypeKHR(IntEnum):
...
class VkDeviceFaultVendorBinaryHeaderVersionKHR(IntEnum):
    VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_KHR = 1
    VK_DEVICE_FAULT_VENDOR_BINARY_HEADER_VERSION_ONE_EXT = 1

class VkIndirectCommandsLayoutUsageFlagBitsEXT(IntEnum):
...
class VkShaderCreateFlagBitsEXT(IntEnum):
...
class VkShaderCodeTypeEXT(IntEnum):
    VK_SHADER_CODE_TYPE_BINARY_EXT = 0
    VK_SHADER_CODE_TYPE_SPIRV_EXT = 1

class VkScopeKHR(IntEnum):
...
class VkComponentTypeKHR(IntEnum):
    ...
    VK_COMPONENT_TYPE_FLOAT_E4M3_NV = 1000567002
    VK_COMPONENT_TYPE_FLOAT_E5M2_NV = 1000567003
...
class VkBlockMatchWindowCompareModeQCOM(IntEnum):
    VK_BLOCK_MATCH_WINDOW_COMPARE_MODE_MIN_QCOM = 0
    VK_BLOCK_MATCH_WINDOW_COMPARE_MODE_MAX_QCOM = 1

class VkPhysicalDeviceLayeredApiKHR(IntEnum):
...
class VkLayeredDriverUnderlyingApiMSFT(IntEnum):
...
class VkOutOfBandQueueTypeNV(IntEnum):
    VK_OUT_OF_BAND_QUEUE_TYPE_RENDER_NV = 0
    VK_OUT_OF_BAND_QUEUE_TYPE_PRESENT_NV = 1

class VkMemoryUnmapFlagBits(IntEnum):
    VK_MEMORY_UNMAP_RESERVE_BIT_EXT = 1

class VkCompressedTriangleFormatAMDX(IntEnum):
    VK_COMPRESSED_TRIANGLE_FORMAT_DGF1_AMDX = 0

class VkWaylandSurfaceCreateFlagBitsKHR(IntEnum):
    pass

class VkDepthClampModeEXT(IntEnum):
    VK_DEPTH_CLAMP_MODE_VIEWPORT_RANGE_EXT = 0
    VK_DEPTH_CLAMP_MODE_USER_DEFINED_RANGE_EXT = 1

class VkAccessFlagBits3KHR(IntEnum):
    VK_ACCESS_3_NONE_KHR = 0

class VkTileShadingRenderPassFlagBitsQCOM(IntEnum):
    VK_TILE_SHADING_RENDER_PASS_ENABLE_BIT_QCOM = 1
    VK_TILE_SHADING_RENDER_PASS_PER_TILE_EXECUTION_BIT_QCOM = 2

class VkCooperativeVectorMatrixLayoutNV(IntEnum):
...
class VkTensorUsageFlagBitsARM(IntEnum):
...
class VkDataGraphPipelineSessionBindPointARM(IntEnum):
...
class VkDataGraphPipelineSessionBindPointTypeARM(IntEnum):
    VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TYPE_MEMORY_ARM = 0

class VkDataGraphPipelinePropertyARM(IntEnum):
...
class VkDataGraphPipelineDispatchFlagBitsARM(IntEnum):
    pass

class VkPhysicalDeviceDataGraphProcessingEngineTypeARM(IntEnum):
...
class VkPhysicalDeviceDataGraphOperationTypeARM(IntEnum):
...
class VkDataGraphModelCacheTypeQCOM(IntEnum):
    VK_DATA_GRAPH_MODEL_CACHE_TYPE_GENERIC_BINARY_QCOM = 0

class VkPerfHintTypeQCOM(IntEnum):
...
class VkVideoEncodeRgbRangeCompressionFlagBitsVALVE(IntEnum):
...
class VkSpirvResourceTypeFlagBitsEXT(IntEnum):
...
class VkAddressCommandFlagBitsKHR(IntEnum):
...
class VkDataGraphTOSAQualityFlagBitsARM(IntEnum):
...
class VkDataGraphTOSALevelARM(IntEnum):
    VK_DATA_GRAPH_TOSA_LEVEL_NONE_ARM = 0
    VK_DATA_GRAPH_TOSA_LEVEL_8K_ARM = 1

class VkDataGraphOpticalFlowGridSizeFlagBitsARM(IntEnum):
...
class VkDataGraphOpticalFlowImageUsageFlagBitsARM(IntEnum):
...
class VkDataGraphOpticalFlowPerformanceLevelARM(IntEnum):
...
class VkDataGraphPipelineNodeConnectionTypeARM(IntEnum):
...
class VkDataGraphPipelineNodeTypeARM(IntEnum):
    VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM = 1000631000

class VkDataGraphOpticalFlowCreateFlagBitsARM(IntEnum):
...
class VkDataGraphOpticalFlowExecuteFlagBitsARM(IntEnum):
...
class VkNeuralAcceleratorStatisticsModeARM(IntEnum):
